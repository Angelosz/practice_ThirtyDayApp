...
object HaikuRepository{
    val haikus = listOf(
        ...
        Haiku("Culinary Delight", R.drawable.pexels_photo_23384639, "Colors on a plate,\n" +
                "Flavors dance in harmony,\n" +
                "A feast for the soul."),
        Haiku("Autumn Harvest Table", R.drawable.pexels_photo_28882033, "Pumpkins grace the board,\n" +
